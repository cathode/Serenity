...
!system "xcopy /I License.txt ${BINDIR}\License.txt"
!system "xcopy /I Serenity.sln ${SRCDIR}\Serenity.sln"
!system "xcopy /I License.txt ${SRCDIR}\License.txt"
!system "xcopy /I SolutionInfo.cs ${SRCDIR}\SolutionInfo.cs"
!system "xcopy /I WShelley.public.snk ${SRCDIR}\WShelley.public.snk"
